...
- Software mitigation already applied: `STRAFE_SPEED` (default `40`) runs strafe at a lower duty cycle than `SPEED` to cut current/back-EMF. Lower it further if the reversal persists.
